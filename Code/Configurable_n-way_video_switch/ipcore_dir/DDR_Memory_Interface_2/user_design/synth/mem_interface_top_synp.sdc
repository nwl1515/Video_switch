...
define_attribute          {v:work.DDR_Memory_Interface_2} syn_hier {hard}
...
# clock Constraints
define_clock -disable -name {memc3_infrastructure_inst} -period 2500 -clockgroup default_clkgroup_1
define_clock          -name {memc3_infrastructure_inst.SYS_CLK_INST} -period 2500 -clockgroup default_clkgroup_2
define_clock -disable -name {memc3_infrastructure_inst.u_pll_adv} -period 2500 -clockgroup default_clkgroup_3
